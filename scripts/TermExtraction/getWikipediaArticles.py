...
with open("/user/cringwal/home/Desktop/ProgrammingHistorian/papier_humanistica_2024-main/data/term_extracted/WikipediaEquiv.json", 'w', encoding='utf-8')  as f:
     json.dump(dict_wikipedia_ref, f)
